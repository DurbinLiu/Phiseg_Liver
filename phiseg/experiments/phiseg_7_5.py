...
# todo 修改源数据和预处理数据的路径
preproc_folder = 'E:\\bishe_durbin\\46-PHiSeg-code-master-paper355\data\preproc_data\lidc'
data_root = 'E:\\bishe_durbin\data_lidc.pickle'
