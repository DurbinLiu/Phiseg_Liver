...
# todo 修改自己的相关路径
project_root = 'E:\\bishe_durbin\\46-PHiSeg-code-master-paper355'
local_hostnames = ['amax']  # used to check if on cluster or not
log_root = 'E:\\bishe_durbin\\46-PHiSeg-code-master-paper355\logs'
